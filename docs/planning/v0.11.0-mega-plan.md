# v0.11.0 mega plan — operator controls + client reset + far players + CPU gate (2026-08-12, v1.4; v1.5 2026-08-14: stage N NeoForge + the 1.21.1 backport target)
...
> branch — Fabric + NeoForge only, no Paper, best-effort tier). Schedule
> consequence accepted: every v0.11.0 tag moves out by N's ~2-3 weeks and G
> grows by the 1.21.1 line. The BEST-EFFORT tier (defined in the NeoForge plan
> §6 and CLAUDE.md) pre-authorizes feature cuts on 1.21.1/NeoForge and reduced
> automated coverage (no Tier 3, gametest smoke subset, abbreviated-or-skipped
> soak) — wire compatibility is never tiered.
