# v0.11.0 mega plan — operator controls + client reset + far players + CPU gate (2026-08-12, v1.4; v1.5/v1.6 2026-08-14: stage N NeoForge + the 1.21.1 backport target)
