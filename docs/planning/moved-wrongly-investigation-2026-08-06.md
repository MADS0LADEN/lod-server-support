...
- **M2 — arm `outboundBufferCeilingKB` by default** if E3 shows obuf buildup on real links — **RESOLVED 2026-08-13: shipped as AUTO (0 = per-player drain-rate ceiling), auto-outbound-ceiling-design.md**
